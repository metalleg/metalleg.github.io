                    ...
                    <div className="contact-desc">
                      ...
                      <table className="contact-list">
                        ...
                        <tr>
                          ...
                          <td>
                            <a href={`tele:${this.props.data.phone}`}><i className="icon-phone"></i> {this.props.data.phone}</a>
                          </td>
                        </tr>
                        <tr>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href={this.props.data.resume} target="_blank"><i className="icon-download4"></i> Per 2020</a>
                          </td>
                        </tr>
                      </table>
                    </div>
